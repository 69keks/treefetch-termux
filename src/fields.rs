...
pub fn get_user_host_name(is_christmas: bool) -> Result<(String, String), String> {
    ...
    // Hostname
    let hostname_file = fs::File::open("/data/data/com.termux/files/usr/etc/hostname");
...
pub fn get_distro_name() -> Result<String, String> {
    ...
    let lsb_release = fs::File::open("/data/data/com.termux/files/usr/etc/lsb-release");
...
pub fn get_kernel() -> Result<String, String> {
    let kernel_file = fs::File::open("/data/data/com.termux/files/usr/etc/version");
